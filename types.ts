export type View = 'home' | 'generator' | 'history' | 'templates' | 'linkGenerator' | 'hookGenerator' | 'brandProfile' | 'angleGenerator' | 'login' | 'hashtagGenerator' | 'videoGenerator' | 'contentPlanner' | 'admin-dashboard' | 'admin-users' | 'admin-settings' | 'admin-intelligence' | 'marketResearch' | 'imageStudio' | 'admin-apikey' | 'loading';

export type AdminView = 'dashboard' | 'users' | 'settings' | 'intelligence' | 'apikey';
