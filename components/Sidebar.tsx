...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, setCurrentView, currentUser }) => {
  return (
    <aside className="w-64 bg-card p-4 flex-col justify-between hidden md:flex border-r border-border">
      <div>
            ...
            {currentUser?.role === 'admin' ? (
              <>
                ...
                <NavItem view="admin-settings" label="Pengaturan" currentView={currentView} onClick={setCurrentView}>
                 ...
                 <NavItem view="admin-apikey" label="API Key" currentView={currentView} onClick={setCurrentView}>
                    <KeyIcon />
                </NavItem>
