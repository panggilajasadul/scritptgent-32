...
// FIX: Removed `password` from the generated text as it's not available on the User type.
        ...
        <div className="max-h-60 overflow-y-auto bg-secondary p-4 rounded-lg space-y-4">
          {users.map(user => (
            <div key={user.id} className="text-sm border-b border-border pb-2 last:border-b-0 last:pb-0">
              ...
              {/* FIX: Removed password display as it's not available on the User type. */}
