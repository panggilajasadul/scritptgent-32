...
const UserEditModal: React.FC<UserEditModalProps> = ({ user, onClose, onSave }) => {
    ...
    const handleSave = async () => {
        ...
        const updatedUser = {
            ...user,
            username,
            // Password reset needs a separate secure flow, this is a placeholder
        ...
        <Modal title={`Edit Pengguna: ${user.username}`} onClose={onClose}>
            <div className="space-y-4">
                ...
                <Input
                    ...
                    placeholder="Reset password memerlukan backend"
                    disabled // Password changes should be done via a secure backend function
                />
                <Input
