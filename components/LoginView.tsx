        ...
        >
          ...
          <div className="text-center md:text-left">
            ...
            <p className="mt-4 text-base text-text-secondary sm:text-lg md:text-xl">
              ScriptGen 3.0 adalah AI Assistant untuk Kreator Affiliate TikTok & Shopee. Stop buang waktu, mulai buat konten yang terbukti menghasilkan konversi.
            </p>
          </div>
          {/* Login Form */}
          <div>
            ...
            <div className="space-y-4">
                ...
                <Accordion title="Bagaimana cara kerjanya?">
                 ...
                 <Accordion title="Apa bedanya dengan AI lain?">
                     <p className="text-text-secondary px-4 pb-2">ScriptGen 3.0 dilatih khusus dengan ribuan data skrip video affiliate yang sukses. Fokus kami bukan cuma teks, tapi struktur narasi, psikologi marketing, dan hook yang terbukti efektif di platform video pendek.</p>
                </Accordion>
            </div>
        </motion.section>
